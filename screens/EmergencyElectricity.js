...
const EmergencyElectricity = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.emergencyelectricity, styles.iconLayout]}>
      ...
      <View style={[styles.electricity, styles.homeShadowBox]}>
        <Text style={[styles.electricityCompany123456789, styles.home2Typo]}>
...
export default EmergencyElectricity;
