...
const EmergencySecretory = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.emergencysecretory, styles.iconLayout]}>
      ...
      <View style={[styles.secretory, styles.homeShadowBox]}>
        <Text style={[styles.secretory123456789, styles.home2Typo]}>
          Secretory: 123456789
        </Text>
      </View>
...
export default EmergencySecretory;
