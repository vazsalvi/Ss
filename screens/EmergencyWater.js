...
const EmergencyWater = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.emergencywater, styles.iconLayout]}>
      ...
      <View style={[styles.water, styles.homeShadowBox]}>
        <Text style={[styles.waterCompany123456789, styles.home2Typo]}>
