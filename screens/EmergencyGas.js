...
const EmergencyGas = () => {
  ...
  return (
    <View style={[styles.emergencygas, styles.iconLayout]}>
      <View style={[styles.home, styles.homePosition]}>
        ...
        >
          <Text style={[styles.home2, styles.home2FlexBox]}>Home</Text>
        </Pressable>
      </View>
      ...
      <View style={[styles.gasCompany, styles.homeShadowBox]}>
        <Text style={[styles.gasCompany123456789, styles.home2FlexBox]}>
