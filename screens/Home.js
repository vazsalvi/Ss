...
const Home = () => {
  ...
  return (
    <View style={styles.home}>
      ...
      <Pressable
        style={[styles.requestWrapper, styles.wrapperPosition3]}
        onPress={() => navigation.navigate("Request1")}
      >
        <View style={[styles.member, styles.memberChildLayout]}>
          <View style={[styles.requestChild, styles.childShadowBox]} />
          <Text style={[styles.request1, styles.membersTypo]}>Request</Text>
          <Image
