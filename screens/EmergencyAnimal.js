...
const EmergencyAnimal = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.emergencyanimal, styles.iconLayout]}>
      ...
      <View style={[styles.animalContrl, styles.homeShadowBox]}>
        <Text style={[styles.animalControl123456789, styles.home2Typo]}>
...
export default EmergencyAnimal;
