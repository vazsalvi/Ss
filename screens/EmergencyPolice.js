...
const EmergencyPolice = () => {
  ...
  return (
    <View style={[styles.emergencypolice, styles.iconLayout]}>
      ...
      <View style={[styles.police, styles.homeShadowBox]}>
        <Text style={[styles.police123456789, styles.home2Typo]}>
          Police:123456789
        </Text>
      </View>
    </View>
...
export default EmergencyPolice;
