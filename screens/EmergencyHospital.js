...
const EmergencyHospital = () => {
  ...
  return (
    <View style={[styles.emergencyhospital, styles.iconLayout]}>
      ...
      <View style={[styles.localHospital, styles.homeShadowBox]}>
        <Text
          style={[styles.localHospital123456789, styles.home2Typo]}
