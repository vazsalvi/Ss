...
const EmergencyFire = () => {
  ...
  return (
    <View style={[styles.emergencyfire, styles.iconLayout]}>
      ...
      <View style={[styles.fireDepartment, styles.homeShadowBox]}>
        <Text style={[styles.fireDepartment123456789, styles.home2Typo]}>
